 ...
 */
package ezequiel.faiella.proyecto_1.persistencia;

import ezequiel.faiella.proyecto_1.logica.Automovil;
import ezequiel.faiella.proyecto_1.persistencia.exceptions.NonexistentEntityException;
...
public class AutomovilJpaController implements Serializable {
    ...
    // constructor para le jpa
    public AutomovilJpaController(){
        emf = Persistence.createEntityManagerFactory("Ezequiel.Faiella_Proyecto_1_ja r_1.0-SNAPSHOTPU");
    }
    //
